  ...
  return (
    <div className="bg-primary-dark text-white py-2 relative overflow-hidden z-50">
      <div className="flex items-center">
        {/* Static label */}
        <div className="flex-shrink-0 flex items-center gap-2 bg-[#0196FD] text-white font-bold text-xs px-4 py-1 z-10">
          <Megaphone size={14} />
        ...
        <button
          ...
          className="flex-shrink-0 flex items-center gap-1 bg-[#0196FD] hover:bg-[#0082de] text-white text-xs font-bold px-4 py-1.5 rounded-sm transition-colors duration-200 mr-2 shadow-sm"
        >
          Apply Now
